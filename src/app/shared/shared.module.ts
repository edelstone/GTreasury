...
import { TitleActionBarComponent } from './components/title-action-bar/title-action-bar.component';
...
@NgModule({
  ...
  exports: [HeaderComponent, SidebarComponent, SubheaderComponent, GridActionBarComponent, TitleActionBarComponent],
})
